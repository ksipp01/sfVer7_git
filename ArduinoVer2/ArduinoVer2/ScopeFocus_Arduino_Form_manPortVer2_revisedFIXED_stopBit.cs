...
*/
                                 ...
                                 posMin = (int)GetIntersectPos((double)minHFRpos[apexHFR - 2], (double)minHFRpos[apexHFR + 2], (double)list[apexHFR - 2], (double)list[apexHFR + 2], slopeHFRdwn, slopeHFRup);
                                 textBox4.Text = posMin.ToString();
...
{
    gotopos(Convert.ToInt16(minHFRpos[apexHFR + 5]));
    fileSystemWatcher3.EnableRaisingEvents = true;
    textBox14.Text = avg.ToString();
}
