                ...
                if (currentfilter == 1)
                {
                    ...
                    if (checkBox14.Checked == true)
                    {
                       ...
                       // filteradvance();//back to pos 1 
                        ...
                        editfound = 0;
                        Nebname = "Flat2";
                        subsperfilter = (int)numericUpDown33.Value;
                        CaptureTime = (int)numericUpDown35.Value;
                        CaptureBin = (int)numericUpDown37.Value;
                        FilterFocusOn = false;
                        //  fileSystemWatcher4.EnableRaisingEvents = true;
                        if ((FlatCalcDone == false) & (checkBox15.Checked == true))
                        {
        ...
        */
        ...
        private void SequenceGo()
        {
            try
            {
                ...
                totalsubs = (int)numericUpDown12.Value + (int)numericUpDown13.Value + (int)numericUpDown14.Value + (int)numericUpDown15.Value + (int)numericUpDown20.Value + (int)numericUpDown29.Value + (int)numericUpDown32.Value + (int)numericUpDown33.Value;
                ToolStripProgressBar();
        ...
        private void button28_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                textBox24.Text = "Filter Position 1";
            }
...
*/
        ...
        private void Connect()
        {
            ...
            {
                Log("Connect Error Line 5830");
                Send("Connect Error Line 5830");
                FileLog("Connect Error Line 5830");
...
//try to get cursor position from neb*****doesn't work****
       ...
       private void PHDAutoStar()
       {
           ...
           {
               Log("PHDAutostar Error");
               Send("PHDAutostar Error");
               FileLog("PHDAutostar Error");
           }
       }
        ...
        private void PHDCoordStar()
        {
            ...
            {
               Log("PHDCoordStar Error");
               Send("PHDCoordStar Error");
               FileLog("PHDCoordStar Error");
            }
...
*/
     ...
     public void importDataFromExcel()
        ...
        private void CalculateFlatExp()//calcflat
        {
            if (Nebname == "Flat1")
            FlatExp = (double)numericUpDown34.Value/1000;
            if (Nebname == "Flat2")
                FlatExp = (double)numericUpDown35.Value/1000;
...
//*****all of these allow for ONLY numeric entry in these texboxes
        ...
        private void button39_Click_1(object sender, EventArgs e)
        {
            ...
            FindCenter f2 = new FindCenter();
          //  f2.Show();
            f2.StartPosition = FormStartPosition.CenterParent;
         //   f2.Location = new Point(10, 10);  can define where on desktop window goes
            if (f2.ShowDialog() == DialogResult.OK)
            {
               ...
               // Thread.Sleep(2000);
                using (Form newForm = new Form()) 
                {
                   ...
                   // boxpos.X = 20;
                 //   boxpos.Y = 20;
                    newForm.Location = new Point(200,200);//this isn't working
               

                
                    MessageBox.Show(newForm, "Move cursor to star the hit enter");
                    newForm.Focus(); 
                }
                 */
                SetForegroundWindow(NebhWnd);
                ...
                Point pt = new Point();
                GetCursorPos(ref pt);
                GetWindowRect(NebhWnd, out rc);//find upper left corner to reference location on screen.  
                //allows for converion of position to "acitve window"
                //      textBox35.Text = rc.left.ToString();
                //      textBox36.Text = rc.top.ToString();
                Point xxx = new Point();
                //  xxx.X = Convert.ToInt16(textBox33.Text.ToString()) - Convert.ToInt16(textBox35.Text.ToString());
                //   xxx.Y = Convert.ToInt16(textBox34.Text.ToString()) - Convert.ToInt16(textBox36.Text.ToString());
                xxx.X = pt.X - rc.left - 9; //correct for left and top boarder
                xxx.Y = pt.Y - rc.top - 68;

                // textBox31.Text = xxx.X.ToString();
                //  textBox32.Text = xxx.Y.ToString();
                textBox37.Text = xxx.ToString();
            }
...
//**********also consider this:
        ...
        private void PHDCheckSNR()
        {
            ...
            catch
            {
                ...
                Log("PHD Low SNR error");
                Send("PHD Low SNR error");
                FileLog("PHD Low SNR error");
            }
        }
