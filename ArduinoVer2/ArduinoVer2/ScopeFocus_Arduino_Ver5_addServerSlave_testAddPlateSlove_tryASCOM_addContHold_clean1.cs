            ...
            if (portopen == 1)
            {
                ...
                if (vProgress == nn)
                {
                    ...
                    if (_gotoFocusOn == true)
                    {
                        ...
                        string strLogText;
                        strLogText = "Goto Focus Position " + Convert.ToInt16(BestPos).ToString() + "Current Filter_";
...
//Data d = new Data();
      ...
      //  double CalibrationTol;//may not need this variable...in equation uses textbox value and convert to doulg 
        ...
        private void ButtonDisable_Click_1(object sender, EventArgs e)
        {
            ...
            WindowsFormsApplication1.Properties.Settings.Default.sigma = Convert.ToInt16(textBox60.Text);
        ...
        private void button8_Click_2(object sender, EventArgs e)
        {
            try
            {
                if (GlobalVariables.Portselected == null)
                {
        ...
        private void MainWindow_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (timer2.Enabled)
                timer2.Enabled = false; //**************added 4-12-13*********
            if (scope.Connected == true)//  ******this need to be fixed******  6-20-13
            {
        ...
        private void EquipRefresh()
        {
          // GlobalVariables.EquipPrefix = comboBox7.Text + "_" + comboBox8.Text;
            if (comboBox8.Text == "NB")
            {
                ...
                GlobalVariables.EquipPrefix = comboBox7.Text + "_" + comboBox8.Text;
            /*
            if (comboBox8.Text == "NB")//define separate v-curves for NB filters
            {
                if (radioButton9.Checked == true)
                    _equip = GlobalVariables.EquipPrefix + "_" + Filtertext + "_E";
                if (radioButton10.Checked == true)
                    _equip = GlobalVariables.EquipPrefix + "_" + Filtertext + " _R";
                else
                    _equip = GlobalVariables.EquipPrefix;
            }
             */
          //  else//since LRGB are very parfocal...no need to have separate V-curves for each one
          //  {
                if (radioButton9.Checked == true)
...
*/
        ...
        public static string text;
            ...
            {
              sigma = Convert.ToInt16(textBox60.Text.ToString());
...
while(true)
 ...
 if(sr.Peek() >= 0)
         ...
         //       TimeToFlip = scope.SiderealTime - scope.RightAscension;
             // TimeSpan ts = TimeSpan.FromHours(Decimal.ToDouble(scope.SiderealTime));
                ...
                int M = ts.Minutes;
                int S = ts.Seconds;
                string TF = H.ToString() + ":"  + M.ToString()  + ":" +  S.ToString();
                textBox56.Text = (TF);
            }
