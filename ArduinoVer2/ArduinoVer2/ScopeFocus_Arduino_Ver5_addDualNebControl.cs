...
//***********this server version controls 2 nebs via 2 sockets.  See server slave for alt. 
...
*/
        ...
        public string MainWindowName = "Nebulosity";
...
private void DisplayCurrentFilter()
{
    ...
    catch
   {
        ...
        */
        private void NebCapture2()//nebcapturehere (for searching)
        {
            try
            {
                Capturing = true;

            //    NebListenStart(NebhWnd2, SocketPort2);
                //   }
                Thread.Sleep(3000);
                if (FlatsOn == true)
                {
                ...
                if (DarksOn == false)
                {
                    ...
                    try
                    {
                        serverStream2.Write(outStream, 0, outStream.Length);
                    }
                    catch
                    {
            ...
            {
                Log("NebCapture2 Error" + e.ToString());
                Send("NebCapture2 Error" + e.ToString());
                FileLog("NebCapture2 Error" + e.ToString());
...
//*********************************************************************
        ...
        private void WaitForSequenceDone()
        {
             int StatusstripHandle = FindWindowEx(NebhWnd, 0, "msctls_statusbar32", null);
        ...
        private void SequenceGo()
        {
            try
            {
                ...
                if (checkBox20.Checked == true)
                {
                    ...
                    Thread.Sleep(1000);
                    PostMessage(Capturehwnd, BN_CLICKED, 0, 0);//*******added 3_13
                    Thread.Sleep(500);
                     */
        ...
        private void fileSystemWatcher5_Changed(object sender, FileSystemEventArgs e)
        {
            ...
            {
                Log("Metric Error Line 4223" + ex.ToString());
                Send("Metric Error Line 4223" + ex.ToString());
                FileLog("Metric Error Line 4223" + ex.ToString());
        ...
        private void button27_Click(object sender, EventArgs e)
        {
            ...
            {
                Log("Metric Error Line 4279" + ex.ToString());
            }
...
*/
        ...
        private void Connect(int port)
        {
            ...
            {
                Log("Connect Error Line 5830" + e.ToString());
                Send("Connect Error Line 5830" + e.ToString() );
                FileLog("Connect Error Line 5830" + e.ToString());
...
/*
        ...
        public void NebSlavePause()
        {
            SetForegroundWindow(NebhWnd2);//? may not need 3-4
            Thread.Sleep(1000);//may not need 3-4
            SetForegroundWindow(Aborthwnd2);
            PostMessage(Aborthwnd2, BN_CLICKED, 0, 0);
            Thread.Sleep(1000);
       ...
       int SocketPort2;
        ...
        private void checkBox20_CheckedChanged_1(object sender, EventArgs e)
        {
          ...
          //  SearchData sd = new SearchData { Wndclass = "WindowsForms10", Title = "scopefocus" };
            ...
            IntPtr hWnd2 = SearchForWindow("wxWindow", MainWindowName);//must open file named test.fit to specifiy second copu
            Log("Neb slave Handle Found -- " + hWnd2.ToInt32());
        ...
        private void checkBox14_CheckedChanged_1(object sender, EventArgs e)
        {
            if (checkBox14.Checked == true)
            {
                if (checkBox15.Checked == true)
                    checkBox15.Checked = false;//need to uncheck server
                MainWindowName = "Nebulosity v3.0 - slave.fit";//change the mainwindow label in neb to signify sencond copy
                SocketPort2 = 4302;
                ScriptName = "\\listenPort2.neb";
