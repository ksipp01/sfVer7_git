...
*/
        ...
        public string Neb = "Nebulosity";
        public void FindHandles()
        {
            try
            {
                IntPtr hWnd2 = SearchForWindow("wxWindow", Neb );//must open file named test.fit to specifiy second copu
               ...
               //no need for PHD handle for second camera
        ...
        private void Connect()
        {
            try
            {
                if (clientSocket.Connected == false)//**************try adding 2_29
                {
                    ...
                    clientSocket.Connect("127.0.0.1", SocketPort);//*************try adding and red above)
