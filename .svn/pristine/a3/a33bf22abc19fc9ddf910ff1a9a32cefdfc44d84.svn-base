...
namespace ASCOM.CGEM
{
    ...
    //
    // The Guid attribute sets the CLSID for ASCOM.CGEM.Rate
    // The ClassInterface/None addribute prevents an empty interface called
    // _Rate from being created and used as the [default] interface
    //
    [Guid("66914ccf-9a19-4f0c-b1bc-14cbacc66537")]
    ...
    // this polymorphism. 
    //
    // The Guid attribute sets the CLSID for ASCOM.CGEM.AxisRates
    // The ClassInterface/None addribute prevents an empty interface called
    // _AxisRates from being created and used as the [default] interface
    //
    [Guid("63ffa907-5e35-47f5-a213-1530195e0af7")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComVisible(true)]
    ...
    // this polymorphism. 
    //
    // The Guid attribute sets the CLSID for ASCOM.CGEM.TrackingRates
    // The ClassInterface/None addribute prevents an empty interface called
    // _TrackingRates from being created and used as the [default] interface
    //
    [Guid("e489bb7e-f881-4c86-92aa-6be1eec1c362")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComVisible(true)]
