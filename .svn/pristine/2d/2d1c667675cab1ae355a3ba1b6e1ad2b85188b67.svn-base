            ...
            //    {
                ...
                //try adding backalsh compensation *****doesn't work....need to do at arduino
                    ...
                    if (checkBox29.Checked == true)
                    {
                        ...
                        {
                            moveOut = true; //for the most part first move is out (if started from 0)
       ...
       */
        ...
        */
        ...
        private void FindNebCamera()
        {
            ...
            StatusHelper sh = new StatusHelper(statusHandle);
           // string[] captions = sh.Captions;
            if (sh.Captions[0] == "" || sh.Captions[0] == "No camera selected") //"" if non selected after opening neb, the later is no camera specifically selected
                NoCameraSelected();
            else
            {
                Log(sh.Captions[0]);
