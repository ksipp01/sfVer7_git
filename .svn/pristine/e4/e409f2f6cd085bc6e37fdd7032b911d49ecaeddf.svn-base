             ...
             int max = 1;
                 ...
                 //    textBox5.Text = min.ToString();
                    ...
                    // textBox8.Text = avg.ToString();
                     ...
                     Log("V-Curve:\tTemp " + test.ToString() + "\tPos" + count.ToString() + "  \tHFRavg" + avg.ToString() + "\tHFR" + current.ToString() + "\tminHFR" + min.ToString() + "\tposMin" + posMin.ToString());
